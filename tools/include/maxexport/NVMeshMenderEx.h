/*
NVMeshMenderEx is modified version of NVidia tangent space basis code, from www.nvidia.com
*/
...
void remap( NS(lang,Array)<NS(math,float4)>& vdata, const std::vector<unsigned>& mapping );


/** Input vertex format to createBasisVectors. */
class NVTangentVertex
{
public:
	NS(math,float3) pos;
