...
// disabled for now, would require single lightmapping, doesnt work with normal mapped lightmaps
#undef ENABLE_LIGHTMAPPING
...
half4 pshader( PS_IN IN ) : COLOR
{
	...
	#ifdef ENABLE_LIGHTMAPPING
	half4 lightmap = tex2D(lighttex, IN.uv1);
